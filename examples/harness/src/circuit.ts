import { r, sheet } from 'ts-kicad/helpers'
import { GND, P12V, PWR_FLAG } from 'ts-kicad/power'
import { _5018761840, _212528_0400, TYPE_C_31_M_04, STPS2H100ZFY, BAS40DW_04_7_F, SMF16A_C2943844, DMN3200U_7, DG419LEDY_T1_GE4 } from '../lib/components/symbols'
import { bom } from './bom'
...
export const IGNITION_OUTPUT = r({ value: '1k' }).wire({ P2: DEVICE.SUB2 })
