...
4. Run `ts-kicad export` to check ERC/DRC and write BOM, PDF, fabrication files, positions and mechanical models into `outputs/`.
...
Usage: ts-kicad <command> [options]
  ...
  export              Check ERC/DRC and export BOM, PDF, fabrication files, positions and mechanical models.
