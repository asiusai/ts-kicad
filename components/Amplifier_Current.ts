...
export class AD8212 extends Component.withPins({
  ...
  "V+": "1",
  /** Physical pin 2: COM; input. */
  "COM": "2",
  /** Physical pin 3: BIAS; input. */
  "BIAS": "3",
  /** Physical pin 4: NC; no_connect. */
  "NC_4": "4",
  /** Physical pin 5: Iout; output. */
  "Iout": "5",
  /** Physical pin 6: ALPHA; output. */
  "ALPHA": "6",
  /** Physical pin 7: NC; no_connect. */
  "NC_7": "7",
  /** Physical pin 8: Vsns; input. */
  "Vsns": "8",
}) {
...
export class AD8218xCP extends Component.withPins({
  /** Physical pin 1: +IN; input. */
  "+IN": "1",
  /** Physical pin 2: Vs; passive. */
  "Vs": "2",
  /** Physical pin 3: ENB; input. */
  "ENB": "3",
  /** Physical pin 4: GND; power_in. */
  "GND_4": "4",
  /** Physical pin 5: OUT; output. */
...
export class INA200D extends Component.withPins({
  ...
  "OUT": "2",
  /** Physical pin 3: CMP_{IN}; input. */
  "CMP_{IN}": "3",
  /** Physical pin 4: GND; power_in. */
  "GND": "4",
  /** Physical pin 5: ~{RESET}; input. */
  "~{RESET}": "5",
  /** Physical pin 6: CMP_{OUT}; open_collector. */
  "CMP_{OUT}": "6",
  /** Physical pin 7: V_{IN-}; input. */
  "V_{IN-}": "7",
  /** Physical pin 8: V_{IN+}; input. */
  "V_{IN+}": "8",
}) {
...
export class INA225 extends Component.withPins({
  ...
  /** Physical pin 4: OUT; output. */
  "OUT": "4",
  /** Physical pin 5: GS0; input. */
  "GS0": "5",
  /** Physical pin 6: GS1; input. */
  "GS1": "6",
  /** Physical pin 7: REF; passive. */
  "REF": "7",
  /** Physical pin 8: IN-; passive. */
  "IN-": "8",
}) {
...
export class INA253 extends Component.withPins({
  /** Physical pin 1: IS-; passive. */
  "IS-_1": "1",
  /** Physical pin 2: IS-; passive. */
  "IS-_2": "2",
  /** Physical pin 3: IS-; passive. */
  "IS-_3": "3",
  /** Physical pin 4: SH-; passive. */
  "SH-": "4",
  /** Physical pin 5: IN-; passive. */
  "IN-": "5",
  /** Physical pin 6: GND; power_in. */
  "GND_6": "6",
  /** Physical pin 7: DNC1; no_connect. */
  "DNC1": "7",
  /** Physical pin 8: NC; no_connect. */
  "NC_8": "8",
  /** Physical pin 9: VS; power_in. */
  "VS": "9",
  /** Physical pin 10: REF2; passive. */
  "REF2": "10",
  /** Physical pin 11: REF1; passive. */
  "REF1": "11",
  /** Physical pin 12: NC; no_connect. */
  "NC_12": "12",
  /** Physical pin 13: OUT; output. */
  "OUT": "13",
  /** Physical pin 14: DNC2; no_connect. */
  "DNC2": "14",
  /** Physical pin 15: GND; passive. */
  "GND_15": "15",
  /** Physical pin 16: IN+; passive. */
  "IN+": "16",
  /** Physical pin 17: SH+; passive. */
  "SH+": "17",
  /** Physical pin 18: IS+; passive. */
  "IS+_18": "18",
  /** Physical pin 19: IS+; passive. */
  "IS+_19": "19",
  /** Physical pin 20: IS+; passive. */
  "IS+_20": "20",
}) {
...
export class LTC6102xDD extends Component.withPins({
  /** Physical pin 1: -INS; input. */
  "-INS": "1",
  /** Physical pin 2: -INF; input. */
  "-INF": "2",
  /** Physical pin 3: V-; power_in. */
  "V-_3": "3",
  /** Physical pin 4: OUT; output. */
...
export class MAX4081F extends Component.withPins({
  ...
  /** Physical pin 4: GND; power_in. */
  "GND": "4",
  /** Physical pin 5: OUT; input. */
  "OUT": "5",
  /** Physical pin 6: REF1B; input. */
  "REF1B": "6",
  /** Physical pin 7: REF1A; input. */
  "REF1A": "7",
  /** Physical pin 8: RS-; input. */
  "RS-": "8",
}) {
...
export class MAX471 extends Component.withPins({
  ...
  /** Physical pin 4: GND; power_in. */
  "GND": "4",
  /** Physical pin 5: SIGN; open_collector. */
  "SIGN": "5",
  /** Physical pin 6: RS-; input. */
  "RS-_6": "6",
  /** Physical pin 7: RS-; input. */
  "RS-_7": "7",
...
export class ZXCT1009F extends Component.withPins({
  /** Physical pin 1: Vs-; input. */
  "Vs-": "1",
  /** Physical pin 2: Vs+; input. */
  "Vs+": "2",
  /** Physical pin 3: Iout; output. */
  "Iout": "3",
}) {
...
export class ZXCT1009T8 extends Component.withPins({
  ...
  /** Physical pin 2: NC; no_connect. */
  "NC_2": "2",
  /** Physical pin 3: Vs+; input. */
  "Vs+": "3",
  /** Physical pin 4: Iout; output. */
  "Iout": "4",
...
export class ZXCT1010 extends Component.withPins({
  ...
  "OUT": "3",
  /** Physical pin 4: Vs+; input. */
  "Vs+": "4",
  /** Physical pin 5: Vs-; input. */
  "Vs-": "5",
}) {
