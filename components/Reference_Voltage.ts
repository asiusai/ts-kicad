...
export class ADR1399KEZ extends Component.withPins({
  /** Physical pin 1: -REFS; passive. */
  "-REFS": "1",
  /** Physical pin 2: -REFF; passive. */
  "-REFF": "2",
  /** Physical pin 3: HEATER+; power_in. */
  "HEATER+": "3",
  /** Physical pin 4: NC; no_connect. */
  "NC_4": "4",
  /** Physical pin 5: HEATER-; power_in. */
  "HEATER-": "5",
  /** Physical pin 6: +REFF; passive. */
  "+REFF": "6",
  /** Physical pin 7: +REFS; passive. */
  "+REFS": "7",
...
export class ADR1399KHZ extends Component.withPins({
  ...
  "P2": "2",
  /** Physical pin 3: unnamed; power_in. */
  "P3": "3",
  /** Physical pin 4: unnamed; power_in. */
  "P4": "4",
}) {
...
export class ADR420ARMZ extends Component.withPins({
  ...
  /** Physical pin 4: GND; power_in. */
  "GND": "4",
  /** Physical pin 5: TRIM; passive. */
  "TRIM": "5",
  /** Physical pin 6: OUT; output. */
  "OUT": "6",
  /** Physical pin 7: NC; no_connect. */
  "NC_7": "7",
  /** Physical pin 8: TP; no_connect. */
  "TP_8": "8",
}) {
...
export class ADR440ARMZ extends Component.withPins({
  /** Physical pin 2: V_{IN}; power_in. */
  "V_{IN}": "2",
  /** Physical pin 4: GND; power_in. */
  "GND": "4",
  /** Physical pin 5: TRIM; passive. */
  "TRIM": "5",
  /** Physical pin 6: V_{OUT}; output. */
  "V_{OUT}": "6",
  /** Physical pin 1: NC; no_connect. */
  "NC_1": "1",
  /** Physical pin 3: NC; no_connect. */
...
export class LT1019xN8 extends Component.withPins({
  /** Physical pin 1: DNC; no_connect. */
  "DNC_1": "1",
  /** Physical pin 2: IN; power_in. */
  "IN": "2",
  /** Physical pin 3: TEMP; passive. */
  "TEMP": "3",
  /** Physical pin 4: GND; power_in. */
  "GND": "4",
  /** Physical pin 5: TRIM; passive. */
...
export class MAX6070AAUT12_T extends Component.withPins({
  ...
  /** Physical pin 4: VIN; power_in. */
  "VIN": "4",
  /** Physical pin 5: OUTS; input. */
  "OUTS": "5",
  /** Physical pin 6: OUTF; output. */
  "OUTF": "6",
}) {
...
export class MAX6071AAUT12_T extends Component.withPins({
  /** Physical pin 1: GNDF; power_in. */
  "GNDF": "1",
  /** Physical pin 2: GNDS; power_in. */
  "GNDS": "2",
  /** Physical pin 3: EN; input. */
  "EN": "3",
  /** Physical pin 4: VIN; power_in. */
...
export class MAX874 extends Component.withPins({
  /** Physical pin 1: IC; no_connect. */
  "IC_1": "1",
  /** Physical pin 2: VIN; power_in. */
  "VIN": "2",
  /** Physical pin 3: Temper; output. */
  "Temper": "3",
  /** Physical pin 4: GND; power_in. */
  "GND": "4",
  /** Physical pin 5: TRIM; input. */
...
export class REF191 extends Component.withPins({
  ...
  /** Physical pin 2: Vin; power_in. */
  "Vin": "2",
  /** Physical pin 3: ~{Sleep}; input. */
  "~{Sleep}": "3",
  /** Physical pin 4: GND; power_in. */
  "GND": "4",
  /** Physical pin 5: TP; no_connect. */
  "TP_5": "5",
  /** Physical pin 6: Vout; power_out. */
  "Vout": "6",
  /** Physical pin 7: NC; no_connect. */
...
export class REF3212AMDBVREP extends Component.withPins({
  /** Physical pin 1: GNDF; power_in. */
  "GNDF": "1",
  /** Physical pin 2: GNDS; input. */
  "GNDS": "2",
  /** Physical pin 3: ENABLE; input. */
  "ENABLE": "3",
  /** Physical pin 4: VIN; power_in. */
  "VIN": "4",
  /** Physical pin 5: OUT_S; input. */
  "OUT_S": "5",
  /** Physical pin 6: OUT_F; output. */
  "OUT_F": "6",
}) {
...
export class REF5020AD extends Component.withPins({
  ...
  /** Physical pin 4: GND; power_in. */
  "GND": "4",
  /** Physical pin 5: Trim/NR; passive. */
  "Trim/NR": "5",
  /** Physical pin 6: Vout; power_out. */
  "Vout": "6",
  /** Physical pin 7: NC; no_connect. */
...
export class REF6025xDGK extends Component.withPins({
  ...
  "SS": "3",
  /** Physical pin 4: FILT; passive. */
  "FILT": "4",
  /** Physical pin 5: OUT_S; input. */
  "OUT_S": "5",
  /** Physical pin 6: OUT_F; output. */
  "OUT_F": "6",
  /** Physical pin 7: GND_F; power_in. */
  "GND_F": "7",
  /** Physical pin 8: GND_S; power_in. */
  "GND_S": "8",
}) {
...
export class TL431D extends Component.withPins({
  ...
  "REF": "8",
  /** Physical pin [2,3,6,7]: A; passive. */
  "A": "[2,3,6,7]",
}) {
...
export class TL431PW extends Component.withPins({
  ...
  /** Physical pin 8: REF; passive. */
  "REF": "8",
  /** Physical pin [2,3,4,5,7]: NC; no_connect. */
  "NC": "[2,3,4,5,7]",
}) {
...
export class TLE2425xD extends Component.withPins({
  /** Physical pin 1: OUT; power_out. */
  "OUT": "1",
  /** Physical pin 2: COMMON; power_in. */
  "COMMON": "2",
...
export class TLE2426xD extends Component.withPins({
  ...
  /** Physical pin 7: NC; no_connect. */
  "NC_7": "7",
  /** Physical pin 8: NOISE_REDUCTION; passive. */
  "NOISE_REDUCTION": "8",
}) {
