...
export class BSP75N extends Component.withPins({
  ...
  "IN": "1",
  /** Physical pin 2: DRAIN; passive. */
  "DRAIN": "2",
  /** Physical pin 3: SOURCE; passive. */
  "SOURCE_3": "3",
  /** Physical pin 4: SOURCE; passive. */
  "SOURCE_4": "4",
}) {
...
export class BTS4140N extends Component.withPins({
  /** Physical pin 1: IN; input. */
  "IN": "1",
  /** Physical pin 2: V_{bb}; passive. */
  "V_{bb}_2": "2",
  /** Physical pin 3: OUT; passive. */
  "OUT": "3",
  /** Physical pin 4: V_{bb}; passive. */
  "V_{bb}_4": "4",
}) {
...
export class VNP35N07xx_E extends Component.withPins({
  /** Physical pin 1: INPUT; bidirectional. */
  "INPUT": "1",
  /** Physical pin 2: DRAIN; passive. */
  "DRAIN": "2",
  /** Physical pin 3: SOURCE; passive. */
