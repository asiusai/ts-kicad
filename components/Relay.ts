...
export class Relay_SPST_Latching_1coil extends Component.withPins({
  ...
  "P14": "14",
  /** Physical pin A1: unnamed; passive. */
  "PA1": "A1",
  /** Physical pin A2: unnamed; passive. */
  "PA2": "A2",
}) {
...
export class COTO_3602_Split extends Component.withPins({
  ...
  /** Physical pin A2: unnamed; passive. */
  "PA2": "A2",
  /** Physical pin SH: unnamed; passive. */
  "PSH": "SH",
  /** Physical pin 13: unnamed; passive. */
  "P13": "13",
  /** Physical pin 14: unnamed; passive. */
...
export class DR_L2_3V_Form1 extends Component.withPins({
  ...
  /** Physical pin A2: unnamed; passive. */
  "PA2": "A2",
  /** Physical pin B1: unnamed; passive. */
  "PB1": "B1",
  /** Physical pin B2: unnamed; passive. */
  "PB2": "B2",
  /** Physical pin PE: Earth; passive. */
  "Earth": "PE",
}) {
...
export class RAYEX_L90 extends Component.withPins({
  /** Physical pin 11A: unnamed; passive. */
  "P11A": "11A",
  /** Physical pin 11B: unnamed; passive. */
  "P11B": "11B",
  /** Physical pin 12: unnamed; passive. */
  "P12": "12",
  /** Physical pin 14: unnamed; passive. */
...
export class RAYEX_L90A extends Component.withPins({
  /** Physical pin 13A: unnamed; passive. */
  "P13A": "13A",
  /** Physical pin 13B: unnamed; passive. */
  "P13B": "13B",
  /** Physical pin 14: unnamed; passive. */
  "P14": "14",
  /** Physical pin A1: unnamed; passive. */
...
export class RT42xFxx extends Component.withPins({
  ...
  /** Physical pin A2: unnamed; passive. */
  "PA2": "A2",
  /** Physical pin A3: unnamed; passive. */
  "PA3": "A3",
}) {
