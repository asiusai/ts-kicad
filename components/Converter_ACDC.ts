...
export class BAC05S05DC extends Component.withPins({
  /** Physical pin 1: AC/N; power_in. */
  "AC/N": "1",
  /** Physical pin 2: AC/L; power_in. */
  "AC/L": "2",
  /** Physical pin 3: NC; no_connect. */
  "NC": "3",
  /** Physical pin 4: -Vo; power_out. */
  "-Vo": "4",
...
export class HLK_PM01 extends Component.withPins({
  /** Physical pin 1: AC/L; power_in. */
  "AC/L": "1",
  /** Physical pin 2: AC/N; power_in. */
  "AC/N": "2",
...
export class HS_40003 extends Component.withPins({
  /** Physical pin 1: AC/N; power_in. */
  "AC/N": "1",
  /** Physical pin 5: AC/L; power_in. */
  "AC/L": "5",
  /** Physical pin 7: +Vout; power_out. */
  "+Vout": "7",
  /** Physical pin 9: -Vout; power_out. */
  "-Vout": "9",
}) {
...
export class IRM_02_3_3S extends Component.withPins({
  /** Physical pin 1: AC/L; power_in. */
  "AC/L": "1",
  /** Physical pin 12: +Vo; power_out. */
  "+Vo": "12",
  /** Physical pin 13: -Vo; power_out. */
  "-Vo": "13",
  /** Physical pin 24: AC/N; power_in. */
  "AC/N": "24",
}) {
...
export class IRM_03_3_3 extends Component.withPins({
  /** Physical pin 1: AC/L; power_in. */
  "AC/L": "1",
  /** Physical pin 3: AC/N; power_in. */
  "AC/N": "3",
  /** Physical pin 5: NC; no_connect. */
  "NC": "5",
  /** Physical pin 14: -Vo; power_out. */
  "-Vo": "14",
  /** Physical pin 16: +Vo; power_out. */
  "+Vo": "16",
}) {
...
export class PBO_3_S3_3 extends Component.withPins({
  /** Physical pin 1: AC(N); power_in. */
  "AC(N)": "1",
  /** Physical pin 3: AC(L); power_in. */
  "AC(L)": "3",
  /** Physical pin 5: +V(CAP); passive. */
  "+V(CAP)": "5",
  /** Physical pin 7: -V(CAP); passive. */
  "-V(CAP)": "7",
...
export class TMLM04225 extends Component.withPins({
  /** Physical pin 2: Vout1; power_out. */
  "Vout1": "2",
  /** Physical pin 3: Common; power_out. */
  "Common": "3",
  /** Physical pin 4: Vout2; power_out. */
  "Vout2": "4",
  /** Physical pin 5: AC(L); power_in. */
  "AC(L)": "5",
  /** Physical pin 6: AC(N); power_in. */
...
export class TMLM05103 extends Component.withPins({
  ...
  /** Physical pin 2: Vout+; power_out. */
  "Vout+": "2",
  /** Physical pin 3: AC; power_in. */
  "AC_3": "3",
  /** Physical pin 4: AC; power_in. */
  "AC_4": "4",
}) {
...
export class TMPW5_103 extends Component.withPins({
  ...
  /** Physical pin 3: -Vout; power_out. */
  "-Vout": "3",
  /** Physical pin 4: AC(L); power_in. */
  "AC(L)": "4",
  /** Physical pin 5: AC(N); power_in. */
  "AC(N)": "5",
}) {
...
export class VTX_214_010_103 extends Component.withPins({
  /** Physical pin 1: L; power_in. */
  "L": "1",
  /** Physical pin 2: N; power_in. */
  "N": "2",
  /** Physical pin 3: DC+; power_out. */
  "DC+": "3",
  /** Physical pin 4: DC-; power_out. */
  "DC-": "4",
}) {
...
export class VTX_214_015_103 extends Component.withPins({
  /** Physical pin 1: FG; no_connect. */
  "FG": "1",
  /** Physical pin 2: N; power_in. */
  "N": "2",
  /** Physical pin 3: L; power_in. */
  "L": "3",
  /** Physical pin 4: DC+; power_out. */
  "DC+": "4",
  /** Physical pin 5: DC-; power_out. */
  "DC-": "5",
}) {
